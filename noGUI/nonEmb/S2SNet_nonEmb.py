...
calcTIs  =orig_dir+"S2SNetTIs_nonEmb.txt"   # non-emb TI file
...
(SeqList,statGrAll,g)=S2SGmain(False, markov, power, sequences, groups,calcTIs,orig_dir) # non-emb calcs
